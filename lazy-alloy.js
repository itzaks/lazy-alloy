...
Application = (function() {
  ...
  function Application() {
    ...
    this.titanium = null;
    this.program.version('0.0.2').option('-c, --compile', 'Just compile.').option('-w, --watch', 'Watch file changes & compile.').option('-p, --platform [platform]', 'Run titanium on `platform`').option('-d, --directory [dirname]', 'Run in specific subfolder').parse(process.argv);
    this.compiler = new Compiler(this.program.directory || "");
